...
|---|---|---|---|
| [`generate_image`](../server/cli/generate_image.js) | Good | $0.07 at 1K, $0.10 at 2K, $0.15 at 4K | Fast concept frames, drafts, style exploration, and lower-cost image iteration. |
