...
| [`generate_voice`](../server/cli/generate_voice.js) | Good | $0.01 per 500 input characters, rounded up | Dialogue, narration, temp voice tracks, and character voice tests. |
