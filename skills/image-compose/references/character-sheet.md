...
This flow needs current uploaded refs, so per the project `AGENTS.md` § "Choosing context", read `./workflow.json` and identify the reference image nodes for this character:
