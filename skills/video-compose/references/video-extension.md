...
For extending an existing canvas clip (Pattern 4). This file owns the continuity prefix and dependency check. Execution still follows the project `AGENTS.md` § "Draft gate" and § "Choosing context".
...
2. After the user fires A and comes back, resolve A via the project `AGENTS.md` § "Choosing context".
